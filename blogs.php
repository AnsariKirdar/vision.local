        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0 ">
              ...
              <li class="nav-item">
                <a class="nav-link  text-primary fw-bold active" href="<?php echo  $BaseURL ?>/blogs/">Bolgs</a>
              </li>
              <li class="nav-item">
      ...
      <div class="py-5 px-2">
        ...
        <div class="container pb-5 pt-4 bg-white rounded-xlg shadow-lg">
          <div class="row justify-content-evenly">
            ...
            <div class="col-9 col-sm-6 col-md-6 col-lg-3 mt-4">
        ...
        <div class="container pb-5 pt-4 bg-white rounded-xlg shadow-lg">
          ...
          <nav class="mb-3 rounded-3 px-3">
            <div class="nav nav-fill border-0 nav-pills nav-tabs" id="nav-tab" role="tablist">
              ...
              <button class=" btn nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">people</button>
            </div>
          </nav>
      ...
      <div class="py-5 px-2">
        <div class="container pt-5">
          ...
          <div class="row my-3 mt-4">
            <div class="col-4 col-sm-3 col-md-3 col-lg-2 d-flex align-items-center m-3">
